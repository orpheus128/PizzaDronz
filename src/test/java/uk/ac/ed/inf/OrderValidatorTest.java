...
public class OrderValidatorTest extends TestCase {
    ...
    public void testCreditCardCExpiryDateInvalidMonthInFuture() {
        ...
        //creates a random number between 13 and 99, which is not a valid month
    ...
    public void testCreditCardCExpiryDateCurrentDate() {
        ...
        if (currentMonth < 10){
            generatedString = '0' + Integer.toString(currentMonth) + '/' + currentYear;
        }else{
            generatedString = Integer.toString(currentMonth) + '/' + currentYear;
        }
